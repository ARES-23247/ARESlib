...
public class NetworkTableListener {
  public static NetworkTableListener createListener(
      org.areslib.pathplanner.dummy.NetworkTable t,
      java.util.EnumSet<NetworkTableEvent.Kind> k,
      java.util.function.Consumer<NetworkTableEvent> c) {
    return new NetworkTableListener();
  }
