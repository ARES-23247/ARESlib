...
public final class FieldConstants {
     ...
     * <p>
     * In FTC, the driver stations are positioned on the <b>sides</b> (±Y walls) of the field,
     * not the ends. The field-centric heading must be offset so that "forward" on the
     * joystick corresponds to "away from the driver" regardless of alliance.
     * <ul>
     *   <li>{@link #RED} — Driver stands on -Y wall, faces +Y. Heading offset = +90°.</li>
     *   <li>{@link #BLUE} — Driver stands on +Y wall, faces -Y. Heading offset = -90°.</li>
     * </ul>
     */
