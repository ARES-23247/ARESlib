 ...
 * <p>
 * Wraps a {@code double} value that can be changed live from the FTC Dashboard web interface
...
public class TunableNumber {
    ...
    /**
     * Returns true if the value has changed since the last call to {@code hasChanged()}.
     * Use this to avoid reconfiguring controllers every loop when the value hasn't changed.
     *
