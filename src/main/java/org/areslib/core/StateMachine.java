 ...
 *
 * <p>Provides entry/exit/during actions per state, conditional transitions, and automatic timeout
 * transitions. State changes are logged to telemetry for debugging.
 *
 * <pre>{@code
