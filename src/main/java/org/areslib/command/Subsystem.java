...
/**
 * A robot subsystem. Subsystems are the basic building blocks of the command-based framework; they
 * encapsulate hardware devices and provide methods for commands to interact with them.
 *
 * <p>Subsystems must be registered with the {@link CommandScheduler} for their {@link #periodic()}
