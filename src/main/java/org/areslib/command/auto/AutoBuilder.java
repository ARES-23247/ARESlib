 ...
 *
 * <p>Provides a declarative API for composing paths, actions, waits, and parallel groups into a
 * single {@link SequentialCommandGroup}. This is the generic base that accepts any {@link Command}
 * — see the standard AutoBuilder for convenience methods.
 *
 * <pre>{@code
...
public class AutoBuilder {
   ...
   *
   * <p>The deadline command is typically a driving command, and the actions run concurrently
   * alongside it. When the deadline finishes, all other commands are interrupted.
   *
