...
/**
 * A Command that runs instantly; it will initialize, execute once, and
 * finish immediately.
 */
public class InstantCommand extends Command {
    ...
    /**
     * Creates a new InstantCommand with a Runnable that does nothing. Useful only as a no-arg WaitCommand.
     */
