 ...
 * <p>
 * Feeds logged speeds back to the drivetrain and triggers binary actions at the exact 
 * loops they were originally pressed in teleop.
 */
public class GhostPlaybackCommand extends Command {
     ...
     * @param booleanOutputs Varargs array of boolean consumers mapping to the buttons tracked during recording.
     */
    @SafeVarargs
    public GhostPlaybackCommand(String jsonFilePath, Consumer<ChassisSpeeds> driveOutput, Consumer<Boolean>... booleanOutputs) {
