 ...
 * <p>
 * Using quasistatic (voltage ramp) and dynamic (voltage step) tests, SysId mathematically
...
public class SysIdRoutine {
    ...
    public static class Mechanism {
        ...
        /**
         * @param voltageInput The method to apply RAW VOLTAGE to the motor. MUST NOT be constrained by PID or Profile.
         ...
         */
        public Mechanism(Consumer<Double> voltageInput, Supplier<Double> positionOutput, Supplier<Double> velocityOutput, Subsystem... requirements) {
