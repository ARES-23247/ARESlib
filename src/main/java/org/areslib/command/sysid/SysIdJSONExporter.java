...
/**
 * Automatically intercepts WPILib-style SysId routine data and serializes it strictly 
 * to the official `sysid-tool` JSON format. This allows teams to completely skip python `.wpilog` parsers
...
public class SysIdJSONExporter {
    ...
    /**
     * Dumps the accumulated TestRecords into a clean JSON string matching WPILib Schema,
