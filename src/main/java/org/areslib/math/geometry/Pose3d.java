 ...
 *
 * <p>Used for representing the full 6-DOF position and orientation of cameras, AprilTags, and
 * robots in 3D space. Supports transformation composition and projection to 2D for field-relative
 * operations.
 */
public class Pose3d {
   ...
   *
   * <p>The transform is applied as: new_translation = old_translation + rotation *
   * transform.translation, new_rotation = old_rotation * transform.rotation
   *
   ...
   *
   * <p>Equivalent to: this = other.transformBy(result)
   *
   ...
   *
   * <p>This is the primary method for converting AprilTag 3D detections to field-plane poses.
   *
