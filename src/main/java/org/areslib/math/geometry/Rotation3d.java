 ...
 * <p>
 * Quaternions avoid gimbal lock and provide smooth interpolation. This class is used
 * for AprilTag 3D pose estimation, camera mount transforms, and AdvantageScope 3D
 * field visualization.
 */
public class Rotation3d {
    ...
    /**
     * Constructs a Rotation3d from a unit quaternion.
     * The quaternion will be normalized if necessary.
     *
     ...
     * <p>
     * This uses the XYZ convention: roll around X, then pitch around Y, then yaw around Z.
     *
