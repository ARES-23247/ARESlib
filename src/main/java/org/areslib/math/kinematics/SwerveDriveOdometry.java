...
/**
 * Class for swerve drive odometry. Odometry allows you to track the robot's position on the field over a
 * course of a match using readings from your swerve drive encoders and swerve azimuth encoders.
 *
...
public class SwerveDriveOdometry {
    ...
    public SwerveDriveOdometry(
        ...
        for (int i = 0; i < modulePositions.length; i++) {
            m_previousModulePositions[i] = new SwerveModulePosition(modulePositions[i].distanceMeters, modulePositions[i].angle);
        }
    }
