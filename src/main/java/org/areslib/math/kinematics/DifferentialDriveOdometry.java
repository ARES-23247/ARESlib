...
public class DifferentialDriveOdometry {
    ...
    public DifferentialDriveOdometry(
        ...
        m_previousWheelPositions = new DifferentialDriveWheelPositions(
    ...
    public DifferentialDriveOdometry(
            DifferentialDriveKinematics kinematics, Rotation2d gyroAngle, DifferentialDriveWheelPositions wheelPositions) {
        this(kinematics, gyroAngle, wheelPositions, new Pose2d());
    }

    public void resetPosition(Rotation2d gyroAngle, DifferentialDriveWheelPositions wheelPositions, Pose2d pose) {
        m_pose = pose;
        m_previousAngle = gyroAngle;
        m_previousWheelPositions = new DifferentialDriveWheelPositions(
            wheelPositions.leftMeters,
