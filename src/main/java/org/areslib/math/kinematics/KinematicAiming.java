 ...
 *
 * <p>Calculates the required lead angle to hit a static target while the robot is moving, by
 * factoring in the robot's current field-relative velocity and the projectile's expected muzzle
 * velocity. This allows a robot to confidently hit targets while strafing at high speeds.
 */
