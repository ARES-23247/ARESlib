...
public class MecanumDriveOdometry {
    ...
    public MecanumDriveOdometry(
        ...
        m_previousWheelPositions = new MecanumDriveWheelPositions(
    ...
    public MecanumDriveOdometry(
            MecanumDriveKinematics kinematics, Rotation2d gyroAngle, MecanumDriveWheelPositions wheelPositions) {
        this(kinematics, gyroAngle, wheelPositions, new Pose2d());
    }

    public void resetPosition(Rotation2d gyroAngle, MecanumDriveWheelPositions wheelPositions, Pose2d pose) {
        m_pose = pose;
        m_previousAngle = gyroAngle;
        m_previousWheelPositions = new MecanumDriveWheelPositions(
            wheelPositions.frontLeftMeters,
