...
import org.areslib.math.kinematics.MecanumDriveOdometry;
import org.areslib.math.kinematics.MecanumDriveWheelPositions;

/**
 * A sophisticated pose estimator for Mecanum Drives mirroring elite algorithms (WPILib 2024).
...
public class MecanumDrivePoseEstimator {
     ...
     * @param wheelPositions The initial mecanum wheel positions.
    ...
    /**
     * Updates the pose estimator with exactly tracked mecanum wheel positions.
     *
     * @param gyroAngle The current gyro angle.
     ...
     */
    public Pose2d update(Rotation2d gyroAngle, MecanumDriveWheelPositions wheelPositions, double timestampSeconds) {
