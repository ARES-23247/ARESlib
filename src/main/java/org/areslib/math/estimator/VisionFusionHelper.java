 ...
 *
 * <p>Performs the standard rollback-correct-replay algorithm:
 *
 * <ol>
 *   <li>Look up the odometry pose at the vision measurement's timestamp.
 *   <li>Compute the weighted correction offset based on standard deviations.
 *   <li>Replay the odometry twist from the sample time to now on the corrected pose.
 * </ol>
 */
