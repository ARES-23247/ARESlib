 ...
 * global hardware reports and projects them forwards across delayed vision inputs without 
 * requiring rigid WPILib mechanical kinematics implementations.
 */
public class AresHardwarePoseEstimator {
     ...
     * 
     * @param currentHardwarePose The exact pose the external tracker thinks the robot is at globally right now.
    ...
    /**
     * Injects camera offset measurements, retroactively applies them physically backward in time to precisely
     * overlay exact arc motions, and adjusts the estimator globally.
     * 
