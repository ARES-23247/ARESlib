...
/**
 * Implements a bang-bang controller, which outputs either full power or no power based on whether
 * the measurement is below the setpoint.
 *
 * <p>Bang-bang control is extremely effective for controlling high-inertia mechanisms like shooter
 * flywheels where symmetrical motor action across the setpoint is neither required nor desired (you
