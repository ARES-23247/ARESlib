 ...
 * 
 * Used for pose history buffers and vision latency compensations.
 *
...
public class InterpolatingTreeMap<K extends Number, V extends Interpolatable<V>> {
    ...
    /**
     * Retrieves the value at the given key. If the key doesn't exist, it will interpolate
     * between the closest lower and higher keys.
     * 
     * @param key Timestamp.
