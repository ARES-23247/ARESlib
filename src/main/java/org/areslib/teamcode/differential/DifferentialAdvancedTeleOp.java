package org.areslib.teamcode.differential;
 ...
 *
 * <p>Hardware Map Architecture: - 2x standard FTC Motors (e.g. goBILDA) driving the left and right
 * sides. - 1x goBILDA Pinpoint Odometry Computer routing independent tracking wheels directly to
 * the IO layer. - Demonstrates how seamlessly high-end parallel coprocessors map natively into
 * standard drive inputs.
 */
...
public class DifferentialAdvancedTeleOp extends AresCommandOpMode {
  ...
  public void robotInit() {
    ...
    driveSubsystem =
        new DifferentialDriveSubsystem(io, Constants.DriveConstants.DIFFERENTIAL_CONFIG);
