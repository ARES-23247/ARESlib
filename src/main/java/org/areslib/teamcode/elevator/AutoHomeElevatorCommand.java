...
/**
 * Example command demonstrating how to automatically home an elevator using current sensing. Moves
 * the elevator down until a current spike indicates stalling against the physical hardstop.
 */
