 ...
 *
 * <p>This interface defines how generic hardware IO interactions are handled for a tank drive
 * system, enabling hot-swapping between real physical hardware on a robot and a Dyn4j physics
 * simulation.
 */
public interface DifferentialDriveIO {
   ...
   * into the supplied {@link DifferentialDriveInputs} object.
   *
