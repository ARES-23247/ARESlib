 ...
 * This subsystem is fully self-contained within the ARESLib library — it accepts
 * primitive configuration values via its {@link Config} inner class so that team-specific
 * config classes do not leak into the library namespace.
 */
public class SwerveDriveSubsystem extends SubsystemBase implements AresDrivetrain {
     ...
     * Team code should populate an instance of this class and pass it to the subsystem constructor.
     */
    ...
    public void periodic() {
        ...
        SwerveModuleState[] actualStates = new SwerveModuleState[] {
            new SwerveModuleState(flInputs.driveVelocityMps, new Rotation2d(flInputs.turnAbsolutePositionRad)),
            new SwerveModuleState(frInputs.driveVelocityMps, new Rotation2d(frInputs.turnAbsolutePositionRad)),
            new SwerveModuleState(blInputs.driveVelocityMps, new Rotation2d(blInputs.turnAbsolutePositionRad)),
    ...
    public void drive(double forwardMetersPerSec, double strafeMetersPerSec, double turnRadPerSec) {
        ...
        for (int i = 0; i < 4; i++) {
            SwerveModuleState optimizedState = SwerveModuleState.optimize(
                states[i],
                new Rotation2d(inputs[i].turnAbsolutePositionRad)
            );
