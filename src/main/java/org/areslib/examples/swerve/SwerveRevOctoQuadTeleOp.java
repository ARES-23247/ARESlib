package org.areslib.examples.swerve;
 ...
 * - All Drive Motors are connected to the Main REV Hub (e.g. ports 0 to 3)
 * - All Steering Actuators are Continuous Rotation (CR) Servos on the Main REV Hub
 * - All Drive Encoders (quadrature) are routed through the DigitalChickenLabs OctoQuad (Ports 0-3)
 * - All Turn Encoders (REV Through Bore v1 Absolute PWM) are routed through the OctoQuad (Ports 4-7)
 */
