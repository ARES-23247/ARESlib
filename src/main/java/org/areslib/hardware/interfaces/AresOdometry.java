...
/**
 * Hardware-agnostic interface for a 2D generic odometry source. Designed to wrap high-level
 * external pose estimators like the GoBilda Pinpoint or SparkFun OTOS that compute position
 * onboard.
 */
