...
/**
 * Standard implementation mapping FTC Hardware directly to internal physics logic. Enforces native
 * loop optimization via write-caching threshold (0.005 limits).
 */
public class DcMotorExWrapper implements AresMotor, AresEncoder {
  ...
  public void setVoltage(double volts) {
    double currentBattery =
        Math.max(1.0, org.areslib.hardware.AresHardwareManager.getBatteryVoltage());
  ...
  public double getVoltage() {
    return (Double.isNaN(lastSentPower) ? 0.0 : lastSentPower)
        * org.areslib.hardware.AresHardwareManager.getBatteryVoltage();
  }
