...
/**
 * Smart Adapter for the OctoQuad coprocessor.
 * Dynamically configures the hardware pin and routes data from the active driver.
 */
public class AresOctoQuadSensor implements AresAbsoluteEncoder {
    ...
    public void setDistancePerPulse(double distance) {
        // OctoQuad usually returns raw ticks or pulse width, scaling applied at subsystem level typically
    }
    ...
    public double getAbsolutePositionRad() {
        ...
        if (mode == OctoMode.ABSOLUTE || mode == OctoMode.PULSE_WIDTH) {
            // Pulse width typically ranges based on sensor, standard 3.3V PWM absolute is often 0-3.32ms (1-1024 us) mapped to 2pi
            // Usually, getPosition() returns microseconds. Convert standard 1024 us period to 2PI radians.
