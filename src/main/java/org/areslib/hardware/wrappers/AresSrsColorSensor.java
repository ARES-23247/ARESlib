...
public class AresSrsColorSensor implements AresColorSensor {
    ...
    public int getRed() {
        if (getRedMethod != null) {
            try { return ((Number) getRedMethod.invoke(srsHub, port)).intValue(); } catch (Exception ignored) {}
        }
        return 0;
    }
    ...
    public int getGreen() {
        if (getGreenMethod != null) {
            try { return ((Number) getGreenMethod.invoke(srsHub, port)).intValue(); } catch (Exception ignored) {}
        }
        return 0;
    }
    ...
    public int getBlue() {
        if (getBlueMethod != null) {
            try { return ((Number) getBlueMethod.invoke(srsHub, port)).intValue(); } catch (Exception ignored) {}
        }
        return 0;
    }
    ...
    public int getAlpha() {
        if (getAlphaMethod != null) {
            try { return ((Number) getAlphaMethod.invoke(srsHub, port)).intValue(); } catch (Exception ignored) {}
        }
        return 0;
    }
}
