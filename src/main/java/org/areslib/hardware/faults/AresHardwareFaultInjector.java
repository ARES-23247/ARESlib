...
/**
 * A simulation-only tool that allows unit tests (or manual telemetry overrides)
 * to artificially inject catastrophic hardware failures, testing the RobotHealthTracker
 * and the robot's physical drift response.
 */
