...
/**
 * Team-specific mecanum configuration that extends the library's base config.
 * <p>
 * This class adds hardware-specific parameters (wheel diameter, encoder model, gear ratios)
 * on top of the tuning and physics parameters inherited from {@link MecanumDriveSubsystem.Config}.
 */
public class MecanumConfig extends MecanumDriveSubsystem.Config {

    // --- Hardware Conversions ---
    /** Diameter of the drive wheel in millimeters. */
    public double wheelDiameterMM = 96.0; // usually 96mm on mecanum
