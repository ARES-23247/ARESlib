...
public class ElevatorConfig {
    ...
    /** External gear reduction from the encoder output to the spool (e.g. 2.0 if the spool spins twice as slow). */
    ...
    public double getMetersPerTick() {
        ...
        double ticksPerRev = (motorModel == AresMotorModel.CUSTOM) ?
                             customTicksPerRev : motorModel.getTicksPerRev();
