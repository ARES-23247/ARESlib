...
public class ArrayLidarIOSimTest {
  ...
  public void testRaycastHitsObject() {
    ...
    // Standard MAX_RANGE is 4 meters (4000 mm). The center rays should hit the obelisk at ~0.75m to
    // 1.0m (750mm - 1000mm depending on geometry edge)
    // With an 8x8 (64px) array, center pixels should detect it. Let's check if ANY pixel reads <
    // 4000
    boolean hit = false;
    ...
    assertTrue(
        hit,
        "Lidar simulation should have detected the Obelisk 1m directly ahead using physics raycasts.");
  }
}
