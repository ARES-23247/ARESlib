 ...
 * <p>Tests cover:
 * <ul>
 *   <li>Dummy shim layer (Timer, Commands, DriverStation, Filesystem, SendableChooser)</li>
 *   <li>AutoBuilder configuration and auto file parsing</li>
 *   <li>PathPlannerPath construction, bezier generation, and trajectory generation</li>
 *   <li>PPHolonomicDriveController PID output computation</li>
 *   <li>GeometryUtil math (lerp, flip, radius)</li>
 *   <li>FollowPathCommand lifecycle (init → execute → isFinished → end)</li>
 * </ul>
 */
public class PathPlannerShimTest {

    /**
     * AutoBuilder is a static singleton — it must be configured exactly once
     * before any test that calls followPath, pathfindToPose, or buildAuto.
     */
    @BeforeAll
    static void configureAutoBuilder() {
        if (!AutoBuilder.isConfigured()) {
            Subsystem mock = new Subsystem() {
    ...
    class TrapezoidProfileTests {
        ...
        public void testCalculate() {
            ...
            TrapezoidProfile.State result = profile.calculate(
                0.5,
    ...
    class AutoBuilderTests {
        ...
        public void testConfigure() {
            assertTrue(AutoBuilder.isConfigured(),
                "AutoBuilder should be configured via @BeforeAll");
            assertTrue(AutoBuilder.isPathfindingConfigured(),
                "Pathfinding should be configured via @BeforeAll");
        }
        ...
        public void testFollowPath() {
            List<Translation2d> bezier = PathPlannerPath.bezierFromPoses(
    ...
    class PathTests {
        ...
        public void testBezierFromPoses() {
            ...
            List<Translation2d> pts = PathPlannerPath.bezierFromPoses(
        ...
        public void testGoalEndState() {
            ...
            PathPlannerPath path = new PathPlannerPath(bezier,
                new PathConstraints(1, 1, 360, 540), goal);
        ...
        public void testFlipPath() {
            ...
            assertNotEquals(originalX, flippedX, 0.01,
                "Flipped path X should differ from original");
        }
    }
    ...
    class ControllerTests {
        ...
        public void testIsHolonomic() {
            PPHolonomicDriveController ctrl = new PPHolonomicDriveController(
                new PIDConstants(1), new PIDConstants(1), 4.5, 0.4
            );
