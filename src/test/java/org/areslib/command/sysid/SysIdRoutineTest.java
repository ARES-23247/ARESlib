...
public class SysIdRoutineTest {
    ...
    public void testSysIdQuasistatic() {
        ...
        SysIdRoutine.Mechanism mechanism = new SysIdRoutine.Mechanism(voltageInput, positionOutput, velocityOutput);
        SysIdRoutine routine = new SysIdRoutine(config, mechanism);

        org.areslib.command.Command quasistaticCmd = routine.quasistatic(SysIdRoutine.Direction.FORWARD);
