...
class KinematicAimingTest {
    ...
    void testStationaryRobot() {
        ...
        KinematicAiming.AimResult result = KinematicAiming.calculateAim(zeroSpeed, robotPos, targetPos, 20.0);
    ...
    void testMovingOrthogonally() {
        ...
        KinematicAiming.AimResult result = KinematicAiming.calculateAim(strafeSpeed, robotPos, targetPos, 20.0);
    ...
    void testMovingAwayImpossible() {
        ...
        KinematicAiming.AimResult result = KinematicAiming.calculateAim(escapeSpeed, robotPos, targetPos, 20.0);
