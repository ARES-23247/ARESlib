...
class DifferentialDriveOdometryTest {
    ...
    private DifferentialDriveOdometry createOdometry(Pose2d initialPose) {
        return new DifferentialDriveOdometry(
            kinematics, initialPose.getRotation(),
            new DifferentialDriveWheelPositions(0, 0), initialPose);
    }
    ...
    void turnInPlace() {
        ...
        odom.update(new Rotation2d(Math.PI / 2),
            new DifferentialDriveWheelPositions(-arcLength, arcLength));
    ...
    void arcMotion() {
        ...
        odom.update(new Rotation2d(Math.PI / 2),
            new DifferentialDriveWheelPositions(0.5, 1.5));
