...
class DifferentialDrivePoseEstimatorTest {
    ...
    void setUp() {
        ...
        estimator = new DifferentialDrivePoseEstimator(mockKinematics, new Rotation2d(0.0), initialPositions, initialPose);
    }
    ...
    void updateAppliesKinematicStep() {
        ...
        DifferentialDriveWheelPositions newPositions = 
            new DifferentialDriveWheelPositions(1.0, 1.0);
    ...
    void visionMeasurementAppliesCorrectly() {
        ...
        // Re-applying to history creates corrected base pose, plus the replay from t=0.5 to t=1.0 (+1.0 in X)
