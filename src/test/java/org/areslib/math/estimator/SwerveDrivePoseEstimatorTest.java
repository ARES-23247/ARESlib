...
class SwerveDrivePoseEstimatorTest {
    ...
    void setUp() {
        ...
        estimator = new SwerveDrivePoseEstimator(mockKinematics, new Rotation2d(0.0), initialPositions, initialPose);
    }
    ...
    void visionMeasurementAppliesCorrectly() {
        ...
        SwerveModulePosition[] positions1 = new SwerveModulePosition[] {
            new SwerveModulePosition(1.0, new Rotation2d(0.0)),
            new SwerveModulePosition(1.0, new Rotation2d(0.0)),
            new SwerveModulePosition(1.0, new Rotation2d(0.0)),
            new SwerveModulePosition(1.0, new Rotation2d(0.0))
        ...
        SwerveModulePosition[] positions2 = new SwerveModulePosition[] {
