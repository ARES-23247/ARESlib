...
public class IntoTheDeepSim implements GameSimulation {
    ...
    public void initField(World<Body> physicsWorld) {
        ...
        createWall(physicsWorld, wallThick, fieldSize + wallThick*2, -halfField - wallThick/2.0, 0); // Left
        createWall(physicsWorld, wallThick, fieldSize + wallThick*2, halfField + wallThick/2.0, 0);  // Right
        createWall(physicsWorld, fieldSize + wallThick*2, wallThick, 0, -halfField - wallThick/2.0); // Bottom
        createWall(physicsWorld, fieldSize + wallThick*2, wallThick, 0, halfField + wallThick/2.0);  // Top
